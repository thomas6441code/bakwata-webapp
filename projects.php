...
$result = $conn->query("SELECT * FROM project ORDER BY date DESC");
if ($result) {
...
<div class="container min-h-screen mt-20 py-6 text-cyan-950 mx-auto p-6">

    <!-- News Section -->
    <h1 class="text-2xl text-center font-bold mb-4">PROJECTS</h1>
...
<script>
    ...
    function viewEvent(eventid) {
        window.location.href = `project_details.php?id=${eventid}`;
    }
</script>
