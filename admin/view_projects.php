...
<!-- Main Content Area -->
<div class="mt-20 w-full max-w-3xl mx-auto  px-2 py-4  pb-10">
    <div class="min-w-full px-3 text-lg md:px-5">
        <div class="text-cyan-950 mb-20">
            ...
            <div id="projectDetails" class="mb-8 bg-teal-100 p-4 shadow-md">
            ...
            <div class="mt-4 mb-8">
                ...
                <div id="imageGrid" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    foreach ($images as $label => $image) {
                        if (!empty($image)) {
                            echo "<div class='p-2 rounded-lg shadow-sm'>
            ...
            <a href="project.php" class="bg-blue-500 text-white px-6 py-4 rounded-lg shadow hover:bg-blue-600 transition">
                Back to Projects
            </a>
        </div>
    </div>
